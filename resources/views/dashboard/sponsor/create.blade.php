                ...
                <form action="{{ route('sponsors.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @error('short_name') has-error @enderror">
                            ...
                            <input id="short_name" value="{{ old('short_name') }}" class="form-control" type="text" name="short_name">
                            @error('short_name')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @error('type') has-error @enderror">
                            ...
                            <select id="type" class="form-control" name="type">
                                ...
                                <option value="0" {{ old('type') == 0? 'selected':'' }}>Temporary for event</option>
                                <option value="1" {{ old('type') == 1? 'selected':'' }}>Permanent</option>
                            </select>
                            @error('type')
                                <span class="help-block"><small>{{ $message }}</small></span>
                            @enderror
