            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="slider-left">
                        <div class="single-slide">
                            <img src="{{ asset('assets/images/single-slider.png') }}" alt="">
                        ...
                        <div class="single-slide">
                            <img src="{{ asset('assets/images/index-slider-2.png') }}" alt="">
                            <div class="meta-content">
                                <a><span><i class="fas fa-calendar icon"></i> 20 Dec 2020</span></a>
                                <a><span><i class="fas fa-clock icon"></i> 10.00am-12.00pm</span></a>
                ...
                <div class="col-lg-6">
                    <div class="event-campaign-right">
                        ...
                        <div class="gift-children">
                            <img src="{{ asset('assets/images/fresh-water-2.png') }}" class="vector" alt="">
                            <div class="gift-date">
                                <h2>21</h2>
                                <span>Dec</span>
                            </div>
