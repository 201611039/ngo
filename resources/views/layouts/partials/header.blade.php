<header class="main-header">
    ...
    <a href="{{ route('dashboard') }}" class="logo">
      ...
      <span class="logo-lg"><b>Better </b>Life</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Web Developer
                  <small>Member since {{ request()->user()->created_at->format('M \. Y') }}</small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="javascript::void(0)" onclick="$('#logout').submit()" class="btn btn-default btn-flat">Sign out</a>
